...
root.title("Calculator By Krishnal")
root.config(bg="gray")
root.wm_iconbitmap("codeclause1.png")

scvalue = StringVar()
scvalue.set("")
screen = Entry(root, textvar=scvalue, font="lucida 40 bold")
screen.pack(fill=X, ipadx=20, ipady = 15,pady=10, padx=20)
...
b = Button(f, text="00", padx=35, pady=18, font="lucida 35 bold")
b.pack(side=LEFT, padx=18, pady=5)
b.bind("<Button-1>", click)
